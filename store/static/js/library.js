document.addEventListener("DOMContentLoaded", () => {
  ...
  const libraryDataUrl = "/api/library/"; // <-- Mets ici ton URL d'API
  ...
  // Ouvrir la sidebar
  if (openBtn && sidebar && mainContent) {
  ...
  // Fermer la sidebar
  if (closeBtn && sidebar && mainContent && openBtn) {
  ...
  if (expandBtn && sidebar && mainContent && openBtn) {
